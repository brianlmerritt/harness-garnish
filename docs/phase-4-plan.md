...
The 2026-07-20 macOS quota-free Schema 19 suite passed 138 tests with the 2 explicitly opt-in real-container tests ignored; strict Clippy and formatting passed. The fixture matrix proves two retryable failures followed by success, immediate terminal authentication failure, redacted transport uncertainty, restart replay denial, exact request-limit accounting, stable CLI/UI evidence, and verified migration backup. Native-Linux and WSL2 portability evidence remains required for this slice.
